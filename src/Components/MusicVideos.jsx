  ...
  return (
    <section className="px-6 lg:px-16 py-10 bg-white">
      ...
      <h2 className="text-2xl font-bold mb-6 text-black">
        Music <span className="text-red-500">Videos</span>
      </h2>

      {/* Scroll container */}
      <div className="overflow-x-auto lg:overflow-visible">
        <div className="flex gap-6 snap-x snap-mandatory scroll-smooth lg:grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2
">
